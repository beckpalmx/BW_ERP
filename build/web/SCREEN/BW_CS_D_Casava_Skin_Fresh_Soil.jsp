    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function goDelChild()
            {
                ...
                {
                    SURL = "../JSP/BW_CS_D_Casava_Skin_Fresh_Soil.jsp?status_d=3&chk_all=1&username=" + getId("username").value;
                    SURL = SURL + "&doc_id=" + getId("doc_id").value;
                    Delete_Line_no(SURL);
                ...
                {
                    //alert("test");
                    SURL = "../JSP/BW_CS_D_Casava_Skin_Fresh_Soil.jsp?status_d=3&ckbox=";
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        ...
                                        &nbsp;<a href='#' onClick="javascript:openBrWindow('vd_casava_skin__fresh_soil_doc&stadment=and+complete_flag+<>+\'Y\'and+count_rec+<>+0', 115, 'Search_Doc_id_By_DATE.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                        วันที่เอกสาร*&nbsp;
