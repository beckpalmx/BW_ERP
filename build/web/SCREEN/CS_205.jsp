            ...
            <div class="container">
                <div class="panel panel-primary">
                    <div class="panel-heading"> <span class="glyphicon glyphicon-pencil"></span>&nbsp;
                        <b>ทะเบียนคุณสมบัติแป้งที่ต้องการ (CS_205)</b>
                    </div>                        
                                    ...
                                    <td height="313" colspan="2" align="center">
                                        <div style="width:100%;">
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                <tr>
                                                    <td colspan="6" class="h_multi"><input class='cgcButton_10' type="button" id="bt_show" value="แสดงรายละเอียด" onClick="showdetail()">&nbsp;</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div  id="show">
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="30%"><select class='select_cgc2' name="P_add_desc1" id="P_add_desc1">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder">
                                                        <select class='select_cgc2' name="P_add_desc2" id="P_add_desc2">
                                                            <option value="Min" selected>Min</option>
                                                            <option value="Max">Max</option>
                                                            <option value="Min-Max">Min-Max</option>
                                                        </select></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder"><select class='select_cgc2' name="P_add_desc3" id="P_add_desc3">
                                                            <option value="Min" selected>Min</option>
                                                            <option value="Max">Max</option>
                                                            <option value="Min-Max">Min-Max</option>
                                                        </select></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder">
                                                        <select class='select_cgc2' name="P_add_desc4" id="P_add_desc4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder"><select class='select_cgc2' name="P_add_desc5" id="P_add_desc5">
                                                            <option value="Min">Min</option>
                                                            <option value="Max" selected>Max</option>
                                                            <option value="Min-Max">Min-Max</option>
                                                        </select></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder"><select class='select_cgc2' name="P_add_desc6" id="P_add_desc6">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder">
                                                        <select class='select_cgc2' name="P_add_desc7" id="P_add_desc7">
                                                            <option value="Min">Min</option>
                                                            <option value="Max" selected>Max</option>
                                                            <option value="Min-Max">Min-Max</option>
                                                        </select>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder">
                                                        <select class='select_cgc2' name="P_add_desc8" id="P_add_desc8">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder">
                                                        <select class='select_cgc2' name="P_add_desc9" id="P_add_desc9">
                                                            <option value="Null" selected></option>
                                                            <option value="Min">Min</option>
                                                            <option value="Max" selected>Max</option>
                                                            <option value="Min-Max">Min-Max</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder">
                                                        <select class='select_cgc2' name="P_add_desc10" id="P_add_desc10">
                                                            <option value="Null" selected></option>
                                                            <option value="Min">Min</option>
                                                            <option value="Max">Max</option>
                                                            <option value="Min-Max">Min-Max</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder">
                                                        <select class='select_cgc2' name="P_add_desc11" id="P_add_desc11">
                                                            <option value="Null" selected></option>
                                                            <option value="Min">Min</option>
                                                            <option value="Max">Max</option>
                                                            <option value="Min-Max">Min-Max</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder">
                                                        <select class='select_cgc2' name="P_add_desc12" id="P_add_desc12">
                                                            <<option value="Null" selected></option>
                                                            <option value="Min">Min</option>
                                                            <option value="Max">Max</option>
                                                            <option value="Min-Max">Min-Max</option>
