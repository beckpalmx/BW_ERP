                                ...
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject"><input name="doc_id" type="text" id="doc_id" size="10">&nbsp;<a href='javascript:;' onClick="BrownDoc_id()"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                            ...
                                            <input type='button' name='search' onClick="showTable()" value='ค้นหา'/></td>
                                    </tr>
                                            ...
                                            <!--<div width="100%">
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="row3" width="14%">รายการเบิกสินค้า&nbsp;</td>
                                                        <td class="row3" width="10%">คลัง&nbsp;</td>
                                                        <td class="row3" width="10%">กะ&nbsp;</td>
                                                        <td class="row3" width="10%">น้ำหนักบรรจุ(Kg)&nbsp;</td>
                                                        <td class="row3" width="10%">จำนวน(ก/ส)&nbsp;</td>
                                                        <td class="row3" width="13%">รายการเบิกสินค้า&nbsp;</td>
                                                        <td class="row3" width="10%">คลัง&nbsp;</td>
                                                        <td class="row3" width="7%">น้ำหนักบรรจุ(Kg)&nbsp;</td>
                                                        <td class="row3" width="10%">จำนวน(ก/ส)&nbsp;</td>
                                                    </tr>
                                                </table>
                                            </div>-->
                                    ...
                                    <tr>
                                        <td colspan='2' align="right">
                                            <input type='button' name='but1' value='  บันทึก  ' onclick='javascript:Applove();'/>
