...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function goAdd()
            {
                ...
                {
                    getSave(URLsend('doc_id,ticket_text,net_wght,price_unit,price_total,line_no,status_u,username', '../JSP/CS_D_Casava_Skin_2.jsp'));
                    opener.getId("doc_id").disabled = true;
                    showTable("show", "doc_id", "../JSP/CS_Show_D_Casava_Skin_2_doc.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show_D_Casava_Skin_2_doc.jsp?doc_id=")', 800);
    ...
    <body>
        <%!
            ...
            VD_Casava_SkinDAO objDAO = new VD_Casava_SkinDAO();
                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='cust_name' type='text' id="cust_name" value='<%=cust_name%>' size='40' readonly/>                                </td>
                            </tr>
                            <tr>
