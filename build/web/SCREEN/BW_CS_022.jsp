        ...
        <script type="text/javascript">
            ...
            function cal_per_ref() {
                ...
                if (flag == true) {
                    ...
                    //var cal2 = ((parseFloat(getId("A_balance_weight").value).toFixed(2) * (parseFloat(getId("A_per_cent_tapioca").value).toFixed(2))) / 100).toFixed(0);
                    ...
                    getId("A_amount_tapioca").value = cal;                    
