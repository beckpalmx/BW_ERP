                                ...
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td width="607" class="columnobject">
                                            ...
                                            &nbsp;&nbsp;เวลา*
                                            <input name='A_doc_time' type='text' id="A_doc_time" value='' size='10' maxlength="5" readonly/></td>
                                    </tr>
                                    <tr>
                                        <td class="columnlabel">แผนกผู้เบิก*&nbsp;</td>
                                        <td class="columnobject">
                                            <input name='A_dp_id' type='text' id="A_dp_id" value='' size='10' readonly="readonly" />
                                            &nbsp;&nbsp;&nbsp;<input name='dp_id_desc' type='text' id="dp_id_desc" value='' size='30' readonly="readonly" />                                </td>
                                    </tr>
                                    <tr>
