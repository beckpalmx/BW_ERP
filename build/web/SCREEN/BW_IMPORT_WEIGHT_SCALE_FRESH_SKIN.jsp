<%-- 
    Document   : BW_IMPORT_WEIGHT_SCALE_FRESH_SKIN
...
<html>
    ...
    <body onload="addDate();">
        ...
        <input type="hidden" id="process_for" name="process_for" value="FRESH-SKIN">            
        ...
        <table  cellpadding="0"  cellspacing="0">
            <tr>
                ...
                <td  class="ftopcenter" colspan="2">ดึงข้อมูลชั่งน้ำหนักกากมัน (BW_IMPORT_WEIGHT_SCALE_FRESH_SKIN)&nbsp;</td>
