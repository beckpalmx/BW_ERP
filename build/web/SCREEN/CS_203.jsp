    ...
    <body onUnload="closepopup()">
        ...
        <table  cellpadding="0"  cellspacing="0">
            <tr >
                ...
                <td  class="ftopcenter" colspan="2">ทะเบียนกะ (CS_203)</td>
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input class='inputs' type="text" name='shift_id' size='10' value='' id="shift_id" />
                            ...
                            <tr>
                                <td colspan='2' class='blankspace'>
                                    ...
                                    <div align="center">
                                        ...
                                        <a href="javascript:;" onClick="confirmDialogSave(URLsend('chkNull,shift_id,name_t,remark,username','../JSP/CS_203.jsp'))"><img alt=""  src="../IMAGES/BTN_SAVE_90.png" width="80" height="30" border="0"></a>
                                        <a href="javascript:;" onClick="confirmDialogDelete(URLsend('shift_id,name_t,remark,status_d,username','../JSP/CS_203.jsp'))"><img alt=""  src="../IMAGES/BTN_DEL_90.png" width="80" height="30" border="0"></a>
                                    </div>
                                    <br>
                                </td>
                            </tr>
