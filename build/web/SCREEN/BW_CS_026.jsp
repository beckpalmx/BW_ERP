        ...
        <script type="text/javascript">
            ...
            function goDelChild()
            {
                ...
                if(getId("chk_all").checked)//จะทำการลบข้อมูลของ Detail ทั้งหมด ทึ่ตรงกับรหัส
                {
                    ...
                    if(r){
                        SURL = "../JSP/BW_CS_Detail_026.jsp?D_status=3&chk_all=1&username="+getId("A_username").value;
                ...
                {
                    SURL = "../JSP/BW_CS_Detail_026.jsp?D_status=3&ckbox=";
                    for(var i=0;i<document.getElementsByName("ckbox").length;i++)
                    {
                    ...
                    if(Deleteflag != ""){
                        ...
                        Delete_Line_no(SURL);
                        showTableNonPopup("show", "A_doc_id", "../SHOWDETAILSCREEN/BW_CS_Show026.jsp?doc_id=");
                        setTimeout('showTableNonPopup("show", "A_doc_id", "../SHOWDETAILSCREEN/BW_CS_Show026.jsp?doc_id=")', 1000);
                    }else{
                        showTableNonPopup("show", "A_doc_id", "../SHOWDETAILSCREEN/BW_CS_Show026.jsp?doc_id=");
                    }
            ...
            function AddHeader()
            {
                ...
                if(r)
                {
                    ...
                    //alert(strID);
                    getSave(URLsend('chkNull,maxline,'+strID,'../JSP/BW_CS_026.jsp'));
                    ResetValue();
                }
            ...
            function Delete()
            {
                ...
                if(r)
                {
                    getSave(URLsend('D_status,A_doc_id','../JSP/BW_CS_026.jsp'));
                    ResetValue();
                }
            ...
            {
                openBrWindow('vd_product_withdraw_header&stadment=and+create_by=\''+getId('A_username').value+'\'+and+complete_flag+=+\'N\'+and+count_send_complete+'+(input_value==1?'<>+\'0\'':'=+\'0\''), 26, 'Search_Doc_id.jsp');
            ...
            function Runid(output_value,input_value){
                if(getId(input_value).value == ""){
                    AjaxRun_id('A_doc_id', '../JSP/BW_CS_026.jsp?status_runid=4');
                }else{
                    Format_Date(output_value, getId(input_value).value);
                    AjaxRun_id('A_doc_id', '../JSP/BW_CS_026.jsp?status_runid=4&A_doc_id='+getId(output_value).value);
                }
            }
        </script>
...
%>
            ...
            <input type="hidden" name="A_screen_id" id="A_screen_id" value="BW_CS_026">
            <!---------------------------------------------------report----------------------------->
            ...
            <div align="center">
                <table  cellpadding="0"  cellspacing="0">
                    <tr >
                        ...
                        <td  class="ftopcenter" colspan="2">ใบเบิกสินค้าสำเร็จรูป
                                ...
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td width="607" class="columnobject">
                                            ...
                                            <input name='A_doc_time' type='text' id="A_doc_time" value='' size='10' maxlength="5" /></td>
                                    </tr>
                                    <tr>
                                        <td class="columnlabel">แผนกผู้เบิก&nbsp;</td>
                                        <td class="columnobject">
                                            <input name='A_dp_id' type='text' id="A_dp_id" value='' size='10' readonly="readonly" />
                                            &nbsp;&nbsp;&nbsp;<img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' style="cursor: pointer;" onClick="openBrWindow('mdepartment&stadment=and+dept_id=\''+getId('dept_id').value+'\'', 24, 'Search_Config2.jsp');">&nbsp;&nbsp;&nbsp;<input name='dp_id_desc' type='text' id="dp_id_desc" value='' size='30' readonly="readonly" />                                </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                    <tr>
                                                        ...
                                                        <td colspan="5" class="btn_multi">
                                                            <input type='button' class="cgcButton_4" name='but1' value='  เพิ่ม  ' onClick="getId('status_cancle').value == '1'?goAddChild(URLsend('A_doc_id,I_status,A_username','BW_CS_Detail_026.jsp')):CreateNewRow();"/>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject"><input name='A_reporter_id' type='text' id="A_reporter_id" value='' size='10' readonly="readonly" />
