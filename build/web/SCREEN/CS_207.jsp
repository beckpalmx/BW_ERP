    ...
    <body onUnload="closepopup()">
        ...
        <table  cellpadding="0"  cellspacing="0">
            <tr >
                ...
                <td  class="ftopcenter" colspan="2">ทะเบียนประเภท Supplyer&nbsp;(CS_206)</td>
                ...
                <td  colspan="2" class="fcentercenter">
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                <td class="columnlabel"><b>รหัสประเภท Supplyer*</b>&nbsp;</td>
                                <td class="columnobject">
                                    <input type='text' name='supply_type_id' size='10' value='' id="supply_type_id" />
