...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function goAdd()
            {
                ...
                {
                    getSave(URLsend('doc_id,ticket_text,net_wght,price_unit,price_total,line_no,status_u,username', '../JSP/CS_D_Casava_Skin_1.jsp'));
                    opener.getId("doc_id").disabled = true;
                    showTable("show", "doc_id", "../JSP/CS_Show_D_Casava_Skin_doc.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show_D_Casava_Skin_doc.jsp?doc_id=")', 800);
    ...
    <body>
        <%!
            ...
            D_Casava_SkinDAO objDAO = new D_Casava_SkinDAO();
