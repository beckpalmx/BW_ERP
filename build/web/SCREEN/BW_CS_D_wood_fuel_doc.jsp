    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function goDelChild()
            {
                ...
                {
                    SURL = "../JSP/BW_CS_D_wood_fuel_doc.jsp?status_d=3&chk_all=1&username=" + getId("username").value;
                    SURL = SURL + "&doc_id=" + getId("doc_id").value;
                    Delete_Line_no(SURL);
                ...
                {
                    //alert("test");
                    SURL = "../JSP/BW_CS_D_wood_fuel_doc.jsp?status_d=3&ckbox=";
            ...
            function AddHeader()
            {
                ...
                if (r)
                {
                    getSave(URLsend('complete_flag,chkNull,doc_id,doc_date,doc_type,doc_time,remark,username', '../JSP/BW_CS_D_wood_fuel_doc.jsp'));
                    getId("status_cancle").value = "";
                    getId("child_ck").value = "";
                    getId("show").innerHTML = "";
                    getId("doc_id").disabled = false;
    ...
    <body>
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                objs_p = h_p.selectheaderscreen_detail(objs_p, "BW_CS_D_wood_fuel_doc");
