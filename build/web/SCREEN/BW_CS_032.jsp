            ...
            <div align="center">
                ...
                <table  cellpadding="0"  cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td  class="ftopcenter" colspan="2">บันทึกใบแสดงผลิตภัณฑ์
                            (BW_CS_032)&nbsp;</td>
                                ...
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            ...
                                            ประเภทแป้ง&nbsp;&nbsp;
                                            <select name="A_p_type" id="A_p_type">
                                                <option value="P">แป้งผลิต</option>
                                                <option value="R">แป้งถ่าย</option>
                                            </select>&nbsp;&nbsp;
                                            เกรดแป้ง&nbsp;&nbsp;
                                            <select name="A_p_grade" id="A_p_grade">
                                    ...
                                    <tr>
                                        <td class="columnlabel">ผลตรวจสอบ&nbsp;</td>
