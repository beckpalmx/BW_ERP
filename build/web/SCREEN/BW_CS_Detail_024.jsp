    ...
    <body onLoad="select();">
        ...
        <table  cellpadding="0"  cellspacing="0" align="center">
            <tr >
                ...
                <td  class="ftopcenter" colspan="2"><span class="h_multi">ข้อมูลรับสินค้าสินค้า</span>&nbsp;</td>
...
<img height="20" border="0" align="middle" width="20" src="../IMAGES/BUTTON/MAIN/SEARCH20.png" alt="ค้นหา" name="IMAGE4" onclick="openBrWindow('Mwarehouse&textinput=A_wh_in', 31, 'Search_Detail.jsp')">
                            ...
                            <tr>
                                <td class="columnlabel">น้ำหนัก(กก.)&nbsp;</td>
                                <td class="columnobject">
                                    <input name="A_weight" type="text" id="A_weight" size="10" value="<%=weight%>"  onblur="Cal_Total()">                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel">จำนวน(ก/ส)&nbsp;&nbsp;</td>
                                <td class="columnobject">
                                    <input name='A_bag_qty' type='text' id="A_bag_qty" value="<%=bag_qty%>" size='10' onblur="Cal_Total()">                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel">น้ำหนักรวม&nbsp;&nbsp;</td>
                                <td class="columnobject">
                                    <input name='A_quantity' type='text' id="A_quantity" value="<%=quantity%>" size='10' />    
