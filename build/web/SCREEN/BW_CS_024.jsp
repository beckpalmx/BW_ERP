    ...
    <body onUnload="Unload()">
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                objs_p = h_p.selectheaderscreen_process(objs_p, "BW_CS_024");
...
%>
            ...
            <div align="center">
                <table  cellpadding="0"  cellspacing="0">
                    <tr >
                        ...
                        <td  class="ftopcenter" colspan="2">ใบรับสินค้าสำเร็จรูป
                            (BW_CS_024)&nbsp;</td>
        ...
        <!--<input type="button" id="t" onclick="test_amout(parseInt(getId('in').value,10))"><input type="text" id ="in">-->
    </body>
</html>