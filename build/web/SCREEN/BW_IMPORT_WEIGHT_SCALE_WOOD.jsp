<%-- 
    Document   : BW_IMPORT_WEIGHT_SCALE_WOOD
...
<html>
    ...
    <body onload="addDate();">
        ...
        <input type="hidden" id="process_for" name="process_for" value="WOOD">            
        ...
        <table  cellpadding="0"  cellspacing="0">
            <tr>
                ...
                <td  class="ftopcenter" colspan="2">ดึงข้อมูลชั่งน้ำหนัก (BW_IMPORT_WEIGHT_SCALE_WOOD)&nbsp;</td>
