...
วัน/เดือน/ปี : <input type="text" name="date_news" size='10' maxlength="10">

<br>
หัวข้อข่าวฝาก :
<input name="topic_news" type="text" id="topic_news" size="100" />
<br>
แหล่งข่าว :
<input name="place_news" type="text" id="place_news" />
<br>
