...
<%
            ...
            M_Cassava_priceDAO objex = new M_Cassava_priceDAO();
            ...
            if (request.getParameter("D_status") == null) {
                statusnum = uti.numRowdatabase("SELECT Count(cassava_price_id) As num from  m_cassava_price where cassava_price_id = '" + en.EncodeTexttoTIS(request.getParameter("A_cassava_price_id").trim()) + "' and delete_flag = 'N' and complete_flag = 'N'");
                if (statusnum == 0) {
                    statusck = 1;
                } else if (statusnum == 1) {
                    statusck = 2;
