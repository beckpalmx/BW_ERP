...
<%@page import="com.bw.DB.Muser_AccountDAO"%>
<%@page import="com.bw.bean.DataBeanMuser_Account"%>
...
<%
    ...
    if (request.getParameter("status_d") == null) {
        statusnum = uti.numRowdatabase("Select Count(*) As num from  muser_account where username like '" + en.EncodeTexttoTIS(request.getParameter("username").trim()) + "' and delete_flag <> 'Y'");
        if (statusnum == 0) {
            statusck = 1;
        } else if (statusnum == 1) {
            statusck = 2;
