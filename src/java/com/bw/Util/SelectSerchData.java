...
public class SelectSerchData {
    ...
    public String SelectSerchTable(String inputselect)//�觤�Ңͧ&table=?������Table�͡�
    {
        ...
        } else if (inputselect.equals("Vemployee") || inputselect.equals("Vemployee1") || inputselect.equals("Vemployee2") || inputselect.equals("Vemployee3") || inputselect.equals("Vemployee4")) {
