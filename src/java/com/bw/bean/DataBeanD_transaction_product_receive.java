 ...
 * @author B
 */
public class DataBeanD_transaction_product_receive {
   ...
   private String doc_date_system;
    ...
    /**
     * @param withdraw_type the withdraw_type to set
     */
    ...
    /**
     * @return the doc_date_system
     */
    public String getDoc_date_system() {
        return doc_date_system;
    }

    /**
     * @param doc_date_system the doc_date_system to set
     */
    public void setDoc_date_system(String doc_date_system) {
        this.doc_date_system = doc_date_system;
    }
}
