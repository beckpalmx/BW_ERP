...
public class MenuBean {
    ...
    private int sub_menu_range;
    private String img;
    private String img_swap;
    ...
    /**
     * @return the sub_menu_range
     */
    public int getSub_menu_range() {
        return sub_menu_range;
    }

    /**
     * @param sub_menu_range the sub_menu_range to set
     */
    public void setSub_menu_range(int sub_menu_range) {
        this.sub_menu_range = sub_menu_range;
    }
     ...
     * @return the img_swap
     */
    public String getImg_swap() {
        return img_swap;
    }

    /**
     * @param img_swap the img_swap to set
     */
    public void setImg_swap(String img_swap) {
        this.img_swap = img_swap;
    }
