...
public class ScreenBean {
    ...
    /**
     * @param qc_check the qc_check to set
     */
     ...
     * @return the view_doc
     */
    public String getView_doc() {
        return view_doc;
    }

    /**
     * @param view_doc the view_doc to set
     */
    public void setView_doc(String view_doc) {
        this.view_doc = view_doc;
    }
