 ...
 * @author B
 */
public class D_product_withdraw_detailDAO {
    private UtiDatabase objuti;
    private StringQuery objStringQuery;
    int i, numrow;

    public void insert(DataBeanD_product_withdraw_detail DataBean) throws Exception {
        ...
        i = 1;
        try {
            p = con.prepareStatement(objStringQuery.Insert_String(String_input, "d_product_withdraw_detail"));
    ...
    public void insert_suppliers(DataBeanD_product_withdraw_detail DataBean) throws Exception {
        String[] String_input = new String[]{
            "doc_id",
            "line_no",
            "product_id",
        ...
        i = 1;
        try {
            p = con.prepareStatement(objStringQuery.Insert_String(String_input, "d_product_withdraw_suppliers_detail"));
            p.setString(i, DataBean.getDoc_id());i += 1;
            p.setString(i, DataBean.getLine_no());i += 1;
            p.setString(i, DataBean.getProduct_id());i += 1;
            p.setString(i, DataBean.getWeight());i += 1;
    ...
    public void update(DataBeanD_product_withdraw_detail DataBean) throws Exception {
        ...
        i = 1;
        try {
            p = con.prepareStatement(objStringQuery.Update_String(String_update, "d_product_withdraw_detail",
    ...
    public void update_suppliers(DataBeanD_product_withdraw_detail DataBean) throws Exception {
        String[] String_update = new String[]{
            "product_id",
            "weight",
            "bag_qty",
        ...
        i = 1;
        try {
            p = con.prepareStatement(objStringQuery.Update_String(String_update, "d_product_withdraw_suppliers_detail",
                    "where doc_id ='" + DataBean.getDoc_id() + "' and line_no = '" + DataBean.getLine_no() + "' and complete_flag = 'N' and delete_flag = 'N'"));
            p.setString(i, DataBean.getProduct_id());i += 1;
            p.setString(i, DataBean.getWeight());i += 1;
            p.setString(i, DataBean.getBag_qty());i += 1;
    ...
    public void Delete_line_no(String Select_line_no, DataBeanD_product_withdraw_detail DataBean, String Table_Detail) throws Exception {
    ...
    public void Delete_all_line_no(DataBeanD_product_withdraw_detail DataBean, String Table_Detail) throws Exception {
        DBConnect objcon = new DBConnect();
        Connection con = objcon.openNewConnection();
        objStringQuery = new StringQuery();
        PreparedStatement p = null;
    ...
    public DataBeanD_product_withdraw_detail Return_Edit(String doc_id,String line_no)throws Exception{
        DataBeanD_product_withdraw_detail objbean = new DataBeanD_product_withdraw_detail();
        DBConnect objcon = new DBConnect();
        Connection con = objcon.openNewConnection();
        ResultSet rs = null;
        String SQL = "SELECT "
                + "product_id,bag_qty,weight,remark,shift,product_name,quantity,wh_in"
                + " FROM vd_product_withdraw_detail "
    ...
    public DataBeanD_product_withdraw_detail Return_Edit_suppliers(String doc_id,String line_no)throws Exception{
        DataBeanD_product_withdraw_detail objbean = new DataBeanD_product_withdraw_detail();
        DBConnect objcon = new DBConnect();
        Connection con = objcon.openNewConnection();
        ResultSet rs = null;
    ...
    public String Show_Detail(String doc_id, String Screen) throws Exception {
        ...
        ResultSet rs = null;
        String SQL = "";
        total = objuti.numRowdatabase("Select Count(doc_id) As num from  d_product_withdraw_detail where doc_id ='" + doc_id + "' and delete_flag = 'N' and complete_flag ='N' ");
        try {
            ...
            if (total != 0) {
                ...
                if (screen >= 1 && screen <= total) {
                    ...
                    while (rs.next()) {
                        ...
                        Return_String.append("<td class='forborder' width='7%'><a href=\"#\" onclick=\"OpenEdit(URLsend('line_no_" + rs.getString("line_no") + ",A_doc_id','../SCREEN/BW_CS_Detail_026.jsp'))\"><input type='hidden' id='line_no_" + rs.getString("line_no") + "' value=\"" + rs.getString("line_no") + "\"><input type='hidden' id='doc_id' value=\"" + rs.getString("doc_id") + "\"><input type='hidden' id='runno_" + rs.getString("runno") + "'' value=\"" + rs.getString("runno") + "\">" + rs.getString("line_no") + "</a></td>\n");
                ...
                if ((screen % 10) != 0 && screen <= 10) {
                    for (int count = 1; count <= 10 && count <= total_page; count++) {
                        if (count == screen) {
                            ...
                            Return_String.append(" <a href='#'  onclick = \"showTableNonPopup_Detail('show','A_doc_id','s_screen_"+count+"','../SHOWDETAILSCREEN/BW_CS_Show026.jsp?doc_id=')\"><input type = 'hidden' id='s_screen_"+count+"' name='s_screen_"+count+"' value =\""+count+"\">" + count + "</a> |");
                        }
    ...
    public String Show_Detail_suppliers(String doc_id, String Screen) throws Exception {
        ...
        ResultSet rs = null;
        String SQL = "";
        //total = objuti.numRowdatabase("Select Count(doc_id) As num from  d_product_withdraw_suppliers_detail where doc_id ='" + doc_id + "' and delete_flag = 'N' and complete_flag ='N' ");
        total = objuti.numRowdatabase("Select Count(doc_id) As num from  d_product_withdraw_suppliers_detail where doc_id ='" + doc_id + "' and delete_flag = 'N' ");
        try {
            ...
            if (total != 0) {
                ...
                if (screen >= 1 && screen <= total) {
                    ...
                    while (rs.next()) {
                        ...
                        Return_String.append("<td class='forborder' width='7%'><a href=\"#\" onclick=\"OpenEdit(URLsend('line_no_" + rs.getString("line_no") + ",A_doc_id','../SCREEN/BW_CS_Detail_051.jsp'))\"><input type='hidden' id='line_no_" + rs.getString("line_no") + "' value=\"" + rs.getString("line_no") + "\"><input type='hidden' id='doc_id' value=\"" + rs.getString("doc_id") + "\"><input type='hidden' id='runno_" + rs.getString("runno") + "'' value=\"" + rs.getString("runno") + "\">" + rs.getString("line_no") + "</a></td>\n");
                        Return_String.append("<td class='forborder' width='35%'>" + objuti.NotNull(rs.getString("product_id")) + "&nbsp;"+objuti.NotNull(rs.getString("product_name")) + "</td>\n");
                ...
                if ((screen % 10) != 0 && screen <= 10) {
                    for (int count = 1; count <= 10 && count <= total_page; count++) {
                        if (count == screen) {
                            ...
                            Return_String.append(" <a href='#'  onclick = \"showTableNonPopup_Detail('show','A_doc_id','s_screen_"+count+"','../SHOWDETAILSCREEN/BW_CS_Show051.jsp?doc_id=')\"><input type = 'hidden' id='s_screen_"+count+"' name='s_screen_"+count+"' value =\""+count+"\">" + count + "</a> |");
                        }
                    ...
                    for(int count = 1; count <= 10 && count <= total_page; count++){
                        if (count == screen) {
                            Return_String.append("<option selected  value=\'"+count+"\' onclick = \"showTableNonPopup_Detail('show','A_doc_id','select_screen','../SHOWDETAILSCREEN/BW_CS_Show051.jsp?doc_id=')\">"+count+"</option>");
                        }else{
                            Return_String.append("<option   value=\'"+count+"\' onclick = \"showTableNonPopup_Detail('show','A_doc_id','select_screen','../SHOWDETAILSCREEN/BW_CS_Show051.jsp?doc_id=')\">"+count+"</option>");
                        }
                    }
                    Return_String.append("</select>");
                    //**************************************************Select**************************************
