                ...
                case 1:
                    ...
                    if (objuti.numRowdatabase("SELECT count(doc_id) as num from d_job_order_detail  where doc_id = '" + doc_id + "' and  to_number(line_no,'99') <= 12 and delete_flag = 'N' and complete_flag = 'N'") != 0) {
                        ...
                        while (rs.next()) {
                            ...
                            String_Return.append((String)("<td class='forborder' width='7%'><a href=\"#\" class=\"link_data_transparent\" onclick=\"OpenEdit(URLsend('line_no_" + rs.getString("line_no") + ",A_doc_id','../SCREEN/BW_CS_Detail_031.jsp'))\"><input type='hidden' id='line_no_" + rs.getString("line_no") + "' value=\"" + rs.getString("line_no") + "\"><input type='hidden' id='doc_id' value=\"" + rs.getString("doc_id") + "\"><input type='hidden' id='runno_" + rs.getString("runno") + "'' value=\"" + rs.getString("runno") + "\">" + rs.getString("line_no") + "</a></td>\n"));
