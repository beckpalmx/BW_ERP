 ...
 * @author 
 */
public class IMP_Process_transaction_tapiocaDB {

    UtiDatabase objuti;

    public void generater_transaction_tapioca_process(String date_from, String date_to, String process_id, String table, String doc_type, String r, String username) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (a == 0) {
                    ...
                    p.setString(22, objuti.NotNull(rs.getString("percen")));
