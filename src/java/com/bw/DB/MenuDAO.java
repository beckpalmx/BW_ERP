...
public class MenuDAO {
    ...
    public MenuBean selectSubMenu(String data) throws Exception {
        ...
        String sql = "SELECT * From mmenu_sub where sub_menu_id = ? and delete_flag = 'N'";
    ...
    public MenuBean selectMainMenu(String data) throws Exception {
        ...
        ResultSet rs = null;
        Connection con = dbConnect.openNewConnection();
        String sql = "SELECT * From mmenu_main where main_menu_id = ? and delete_flag = 'N'";
        PreparedStatement p = null;
        try {
            p = con.prepareStatement(sql);
            p.setString(1, data);
    ...
    public boolean insertSub(MenuBean menuBean) throws Exception {
        ...
        try {
            ...
            System.out.println(menuBean.getImg());
            System.out.println(menuBean.getImg_swap());
