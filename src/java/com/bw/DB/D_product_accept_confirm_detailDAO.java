...
public class D_product_accept_confirm_detailDAO {
    ...
    public String Show_Detail(String doc_id, String Screen) throws Exception {
        ...
        ResultSet rs = null;
        String SQL = "";
        total = objuti.numRowdatabase("Select Count(doc_id) As num from  d_product_accept_confirm_detail where doc_id ='" + doc_id + "' and delete_flag = 'N' and complete_flag ='N' ");
        try {
    ...
    public String Show_Detail_suppliers(String doc_id, String Screen) throws Exception {
        ...
        ResultSet rs = null;
        String SQL = "";
        total = objuti.numRowdatabase("Select Count(doc_id) As num from  d_product_accept_suppliers_detail_wh where doc_id ='" + doc_id + "' and delete_flag = 'N' and complete_flag ='N' ");
        try {
