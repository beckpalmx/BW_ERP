...
public class D_product_accept_headerDAO {
    ...
    public void insert(DataBeanD_product_accept_header DataBean,ArrayList<DataBeanD_product_accept_detail> ObjAL)throws Exception{
        ...
        try{
            ...
            p.setString(i, objuti.Count_sendcomplete("d_product_accept_header", DataBean.getDoc_id(), DataBean.getComplete_flag(), con));i+=1;
            p.executeUpdate();
            p = null;
    ...
    public void insert_suppliers(DataBeanD_product_accept_header DataBean,ArrayList<DataBeanD_product_accept_detail> ObjAL)throws Exception{
        ...
        try{
            ...
            p.setString(i, DataBean.getComplete_flag());i+=1;
            p.setString(i, DataBean.getCompany_id());i+=1;
            p.setString(i, objuti.Count_sendcomplete("d_product_accept_suppliers_header", DataBean.getDoc_id(), DataBean.getComplete_flag(), con));i+=1;
            p.executeUpdate();
            p = null;
