...
public class T_warehouse_item_totalDAO {
    ...
    public void T_warehouse_item_total(DataBeanT_transaction_stock bean,Connection con) throws Exception {
        ...
        if (objck.Return_value() == 0) {
            Update_Warehouse_Total((bean.getDoc_type().equals("-")) ? bean.getWh_in() : bean.getWh_out(), bean.getProduct_id(),con);
        } else {
            Insert_Warehouse_Total(bean.getProcess_id(),(bean.getDoc_type().equals("-")) ? bean.getWh_in() : bean.getWh_out(), bean.getProduct_id(), bean.getWeight(),con);
        }
    }

    public static void Insert_Warehouse_Total(String Process_id,String Warehouse_id, String Product_id, String Weight,Connection con) throws Exception {
        String SQL = "Insert into t_warehouse_item_total "
                + "(warehouse_id,product_id,weight) "
                + "values(?,?,?)";
    ...
    public static void Update_Warehouse_Total(String Warehouse_id, String Product_id,Connection con) throws Exception {
    ...
    public void T_warehouse_total_product(DataBeanT_transaction_stock bean,Connection con) throws Exception {
        ...
        if (objuti.numRowdatabase(SQL) != 0) {
            Update_Total_Product(bean.getProduct_id(),con);
        } else {
            Insert_Total_Product(bean.getProduct_id(), bean.getWeight(),con);
            
        }
    }

    public static void Insert_Total_Product(String Product_id, String Weight,Connection con) throws Exception {
    ...
    public static void Update_Total_Product(String Product_id,Connection con) throws Exception {
