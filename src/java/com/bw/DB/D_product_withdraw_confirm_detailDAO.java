 ...
 * @author B
 */
public class D_product_withdraw_confirm_detailDAO {
    ...
    public void insert(DataBeanD_product_withdraw_detail DataBean) throws Exception {
        ...
        i = 1;
        try {
            p = con.prepareStatement(objStringQuery.Insert_String(String_input, "d_product_withdraw_confirm_detail"));
    ...
    public void update(DataBeanD_product_withdraw_detail DataBean) throws Exception {
        ...
        i = 1;
        try {
            p = con.prepareStatement(objStringQuery.Update_String(String_update, "d_product_withdraw_confirm_detail",
    ...
    public void update_suppliers(DataBeanD_product_withdraw_detail DataBean) throws Exception {
        ...
        i = 1;
        try {
            p = con.prepareStatement(objStringQuery.Update_String(String_update, "d_product_withdraw_suppliers_detail_wh",
                    "where doc_id ='" + DataBean.getDoc_id() + "' and line_no = '" + DataBean.getLine_no() + "' and complete_flag = 'N' and delete_flag = 'N'"));
            p.setString(i, DataBean.getAmount());i += 1;
            p.setString(i, DataBean.getRemark());i += 1;
            p.setString(i, DataBean.getBy());i += 1;
    ...
    public DataBeanD_product_withdraw_detail Return_Edit(String doc_id,String line_no)throws Exception{
        ...
        String SQL = "SELECT "
                ...
                + " FROM vd_product_withdraw_confirm_detail "
    ...
    public String Show_Detail(String doc_id, String Screen) throws Exception {
        ...
        ResultSet rs = null;
        String SQL = "";
        total = objuti.numRowdatabase("Select Count(doc_id) As num from  d_product_withdraw_confirm_detail where doc_id ='" + doc_id + "' and delete_flag = 'N' and complete_flag ='N' ");
        try {
                ...
                if ((screen % 10) != 0 && screen <= 10) {
                    for (int count = 1; count <= 10 && count <= total_page; count++) {
                        if (count == screen) {
                            ...
                            Return_String.append(" <a href='#'  onclick = \"showTableNonPopup_Detail('show','A_doc_id','s_screen_"+count+"','../SHOWDETAILSCREEN/BW_CS_Show027.jsp?doc_id=')\"><input type = 'hidden' id='s_screen_"+count+"' name='s_screen_"+count+"' value =\""+count+"\">" + count + "</a> |");
                        }
                    ...
                    for(int count = 1; count <= 10 && count <= total_page; count++){
                        if (count == screen) {
                            ...
                            Return_String.append("<option   value=\'"+count+"\' onclick = \"showTableNonPopup_Detail('show','A_doc_id','select_screen','../SHOWDETAILSCREEN/BW_CS_Show027.jsp?doc_id=')\">"+count+"</option>");
                        }
                    }
                ...
                if ((screen % 10) != 0 && screen <= 10) {
                    for (int count = 1; count <= 10 && count <= total_page; count++) {
                        if (count == screen) {
                            ...
                            Return_String.append(" <a href='#'  onclick = \"showTableNonPopup_Detail('show','A_doc_id','s_screen_"+count+"','../SHOWDETAILSCREEN/BW_CS_Show051_WH.jsp?doc_id=')\"><input type = 'hidden' id='s_screen_"+count+"' name='s_screen_"+count+"' value =\""+count+"\">" + count + "</a> |");
                        }
                    ...
                    for(int count = 1; count <= 10 && count <= total_page; count++){
                        if (count == screen) {
                            ...
                            Return_String.append("<option   value=\'"+count+"\' onclick = \"showTableNonPopup_Detail('show','A_doc_id','select_screen','../SHOWDETAILSCREEN/BW_CS_Show051_WH.jsp?doc_id=')\">"+count+"</option>");
                        }
                    }
                    Return_String.append("</select>");
                    //**************************************************Select**************************************
