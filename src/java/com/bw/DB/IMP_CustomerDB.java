 ...
 * @author ball
 */
    public class IMP_CustomerDB {

    UtiDatabase objuti;

    public void generater_import_customer(String date_from, String date_to, String process_id, String table, String doc_type, String r, String username) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                SQL_Search_Rec = "Select Count(customer_id) As num from  mcustomer where customer_id ='" + objuti.NotNull(rs.getString("code")) + "' and delete_flag <> 'Y'  ";
                ...
                if (rec_count == 0) {
                    ...
                    String sql_doc = "insert into mcustomer (customer_id,name_t,remark,address1_t,create_date,create_by) values (?,?,?,?,?,?)";
