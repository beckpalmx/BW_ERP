...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function summit_data() {
                ...
                getsaveApprove2(URLsend(IDsend, "../JSP/BW_PROCESS_CALCULATE_RAWMAT.jsp"), "report");
            }
        </script>        
    ...
    <body onload="addDate();">
        ...
        <input type="hidden" id="process_for" name="process_for" value="PROCESS_RAWMAT">            
        ...
        <table  cellpadding="0"  cellspacing="0">
            <tr>
                ...
                <td  class="ftopcenter" colspan="2">ประมวลผลข้อมูลชั่งน้ำหนักหัวมันสำปะหลัง (BW_PROCESS_CALCULATE_RAWMAT)&nbsp;</td>
                ...
                <td  colspan="2" class="fcentercenter">
                    <div align="left">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                <td class='columnlabel'><b>วันที่เริ่มต้น</b></td><td class='columnobject'><input name='doc_date_from' type='text' id="doc_date_from" value="" readonly/>
                                    ...
                                    <b>ถึง</b>
                                    <input name='doc_date_to' type='text' id="doc_date_to" value="" />
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><textarea name='report' id="report" cols="50" rows="5"></textarea></td>
                            </tr>
                            <tr>
