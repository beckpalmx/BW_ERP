...
<html>
        ...
        <script type="text/javascript">
            function goAdd(){
                ...
                if(ChkParameter(arrayChk))
                {
                    ...
                    alert(strID);
                    getSave_Detail(URLsend(strID,'../JSP/BW_CS_Detail_030_212.jsp'), "../SHOWDETAILSCREEN/BW_CS_Show030_212.jsp?A_doc_line_no="+getId("A_doc_line_no").value+"&A_doc_id=", "show1", getId("A_doc_id").value);
                }
            }
            function goEdit()
            {var arrayChk = new Array;
    ...
    <%
        ...
        if (request.getQueryString().indexOf("line_no_") != -1) {
            ...
            objBean = objdb.Return_Edit(doc_id, doc_line_no, line_no, "d_product_pack_detail_3");
