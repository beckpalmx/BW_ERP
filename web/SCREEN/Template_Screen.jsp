...
<html>
    <head>
        ...
        <script language="javascript" src="../JS/Form/input_form.js"></script>
            ...
            <div class="container">        
                <div class="panel panel-primary">
                    ...
                    <div class="panel-footer">
                        ...
                        <!--button type="button" class="btn btn-success btn-block" data-toggle="tooltip" title="บันทึกข้อมูล" 
                                onclick="confirmAction(this, 'Are you sure you wish to remove this?', performDelete);
                                return false;"><b>ทดสอบ</b></button-->   

                        <!--button type="button" class="btn btn-success btn-block" data-toggle="tooltip" title="บันทึกข้อมูล" 
                                onclick="Do_Action(1);"><b>ทดสอบ</b></button-->
