...
<%@page import="com.bw.bean.DataBeanD_ticketsale"%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function goAdd()
            {
                ...
                {
                    getSave(URLsend('doc_id,ticket_text,net_wght,price_unit,price_total,line_no,status_u,username', '../JSP/CS_D_Casava_Ticket_1.jsp'));
                    opener.getId("doc_id").disabled = true;
                    showTable("show", "doc_id", "../JSP/CS_Show_D_Casava_Ticket_doc.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show_D_Casava_Ticket_doc.jsp?doc_id=")', 800);
    ...
    <body>
        <%!
            ...
            VD_Casava_TicketDAO objDAO = new VD_Casava_TicketDAO();
            DataBeanD_ticketsale objBean = new DataBeanD_ticketsale();
            String doc_id, ticket_text, status_a, status_u, truck_no, cust_name, prod_name, line_no, net_wght, price_unit, price_total, date_in, date_out, time_in, time_out, load_in, load_out;
        %>
        <%
            doc_id = "";
            ticket_text = "";
            ...
            if (request.getQueryString().indexOf("ticket_text_") != -1) {
                ...
                cust_name = objBean.getCust_name();
        ...
        <table  cellpadding="0"  cellspacing="0" align="center">
            <tr >
                ...
                <td  class="ftopcenter" colspan="2">ข้อมูลแป้งมันสำปะหลัง&nbsp;</td>
                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='cust_name' class='inputs' type="text" id="cust_name" value='<%=cust_name%>' size='70' readonly/>                                </td>
                            </tr>
                            <tr>
