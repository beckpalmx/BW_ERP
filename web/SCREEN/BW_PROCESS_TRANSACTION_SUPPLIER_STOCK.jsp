...
<html>
    ...
    <body onload="addDate();">
        ...
        <input type="hidden" id="process_for" name="process_for" value="SUPPLIER_STOCK">            
        ...
        <div class="container">
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-tasks"></span>&nbsp;
                    <b>ประมวลผลการ รับ-จ่าย พัสดุ (กระสอบ - ถุง - พาเลท) (BW_PROCESS_TRANSACTION_SUPPLIER_STOCK)</b>
                </div>                        
