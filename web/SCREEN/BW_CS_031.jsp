    ...
    <body onkeyup="chkEvent()">
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                objs_p = h_p.selectheaderscreen_detail(objs_p, "BW_CS_031");
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td width="607" class="columnobject">
                                        <input name='A_doc_id' class='inputs' type="text" id="A_doc_id" value='' size='20' />
                                ...
                                <tr>
                                    <td class="columnlabel1">ชื่อลูกค้า*&nbsp;</td>
                                    <td class="columnobject">
                                        <input name='A_cust_id' class='inputs' type="text" id="A_cust_id" value='' size='10' readonly />
                                        ...
                                        <input name='cust_id_desc' class='inputs' type="text" id="cust_id_desc" value='' size='30' readonly/>&nbsp;&nbsp;
                                        ชื่อย่อลูกค้า<input class='inputs' type="text" id="A_initial" name="A_initial" value="" >
                                    </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel1">กำหนดเป็น LOT NO*&nbsp;</td>
                                    <td class="columnobject"><input name='A_lot_no' class='inputs' type="text" id="A_lot_no" value='' size='10' />                                  &nbsp;&nbsp;&nbsp;&nbsp;บันทึกคำขอซื้อลูกค้าเลขที่
                                        <input class='inputs' type="text" name="A_po_cust" id="A_po_cust"></td>
                                </tr>
                                <tr>
                                    <td class="columnlabel1">เงื่อนไขการชำระเงิน</td>
                                    <td class="columnobject"><input name='A_payment_condition' class='inputs' type="text" id="A_payment_condition" value='' size='10' />&nbsp;&nbsp;&nbsp;&nbsp;
                                        คำสั่งพิเศษ
                                        <input class='inputs' type="text" name="A_spc_order" id="A_spc_order"></td>
                                </tr>
                                <tr>
                                    <td class="columnlabel1">ชื่อผลิตภัณฑ์</td>
                                ...
                                <tr>
                                    <td class="columnlabel1"><p>จำนวนแจ้งผลิต</p></td>
                                    <td class="columnobject"><input class='inputs' type="text" name="A_prd_qty" id="A_prd_qty">
                                        เมตริกตัน&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จำนวนกระสอบ
                                        <input name="A_bag_qty" class='inputs' type="text" id="A_bag_qty" size="15">
                                        ใบ</td>
                                </tr>
                                <tr>
                                    <td class="columnlabel1"><p>ภาชนะบรรจุ</p></td>
                                    <td class="columnobject"><input class='inputs' type="text" name="A_content" id="A_content">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;น้ำหนักกระสอบเปล่า
                                        <input name="A_bag_weight" class='inputs' type="text" id="A_bag_weight" size="15">
                                        กก.</td>
                                </tr>
                                <tr>
                                    <td class="columnlabel1">รหัสคุณสมบัติ</td>
                                    <td class="columnobject"><input name='A_spec_id' class='inputs' type="text" id="A_spec_id" value='' size='10' readonly />
                                        &nbsp;<a href='javascript:;' onClick="openBrWindow('m_product_spec_header', 301, 'Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='spec_id_desc' class='inputs' type="text" id="spec_id_desc" value='' size='30' readonly/>
                                        &nbsp;</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        <select class='select_cgc2' id="A_adding_qty" name="A_adding_qty" >
                                            <option selected value="1">มี/Stock</option>
                                            <option value="2" >สั่งเพิ่ม/Order</option>
                                        </select>
                                        <input name="A_adding" class='inputs' type="text" id="A_adding" size="15">กระสอบ(Bags)
                                    </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel1">หมายเหตุ&nbsp;</td>
                                    <td class="columnobject"><textarea class='text_inputs' name='A_remark_adding' cols='40' rows='5' id="A_remark_adding"></textarea></td>
                                </tr>
                                <tr>
                                    <td class="columnlabel1">&nbsp;</td>
                                ...
                                <tr>
                                    <td class="columnlabel1">ลักษณะตรา(ถ้ามี)</td>
                                    <td class="columnobject">
                                        <select class='select_cgc2' id="A_mark_sign" name="A_mark_sign" >
