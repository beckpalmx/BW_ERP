...
<html>
    ...
    <body>
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <input type="hidden" name="report_code" value="BWRP_024_WH_WIP">
            ...
            <%
                ...
                if (sql_where.equals("") || sql_where == null) {
                    ...
                    sql_where = sql_where + " and pgroup_id = 'WIP'";
                }
                ...
                while ((rec_tmp_product != null) && (rec_tmp_product.next())) { // Loop Main 
                    ...
                    sql_loop1 = " select product_id,sum(amount_total) as amount_total,pname_t,pgroup_id,weight"
                            ...
                            + " and year = '" + curryear + "'"
                            + " GROUP BY pgroup_id,product_id,pname_t,weight  ";
                    ...
                    while ((rec_loop1 != null) && (rec_loop1.next())) { // Loop 1 
                        ...
                        SqlInsert1 = "INSERT INTO tmp_stock_warehouse_balance(product_id,doc_date,doc_type,data_r,data_w,data_total,data_transfer,pgroup_id,weight) VALUES "
                                ...
                                + "," + rec_loop1.getString("pgroup_id") + "'," + rec_loop1.getDouble("weight") + ")";
                        //+ rec_loop1.getString("price_per_unit") + "','" + rec_loop1.getString("pgroup_id") + "')";
                        
                        System.out.println("1 weight = " + rec_loop1.getDouble("weight"));
                    ...
                    String sql_loop2 = "SELECT runno,doc_date,product_id,"
                            + "doc_type,amount_total,pname_t,pgroup_id,weight"
                            //+ "price_per_unit"
                            //+ " avg(to_number(price_per_unit,'999999.99')) as price_per_unit "
                            + " FROM vt_transaction_warehouse_stock "
                    ...
                    while ((rec_loop2 != null) && (rec_loop2.next())) { // Loop 2
                        ...
                        if (rec_loop == 1) {
                            balance = 0.00;
                            //balance = transfer + rec_loop2.getDouble("amount_total");
                            balance = Double.parseDouble(formatter.format(transfer)) + Double.parseDouble(formatter.format(rec_loop2.getDouble("amount_total")));
                        } else {
                            balance = Double.parseDouble(formatter.format(balance)) + Double.parseDouble(formatter.format(rec_loop2.getDouble("amount_total")));
                        }
                        ...
                        if (rec_loop2.getString("doc_type").equals("-")) {
                            data_w = rec_loop2.getDouble("amount_total");
                            data_r = 0.00;
                        } else {
                        ...
                        System.out.println("2 weight = " + rec_loop2.getDouble("weight"));

                        rec_loop++;

                        SqlInsert2 = "INSERT INTO tmp_stock_warehouse_balance(product_id,doc_date,doc_type,data_r,data_w,data_total,pgroup_id,weight) VALUES "
                                ...
                                + "'" + rec_loop2.getString("pgroup_id") + "'," + rec_loop2.getDouble("weight") + ")";
                        STateMentData = Conn.createStatement();
