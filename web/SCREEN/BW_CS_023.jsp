        ...
        <script type="text/javascript">
            ...
            function Calculator_ALL(){
                ...
                if(value_chk){
                    ...
                    //***********************************คำนวณข้อมูลเปลือกสด***********************************
                    getId('A_amount_peel_fresh').value = (parseFloat(getId('A_total_peel_fresh').value) - Accounted_for('A_total_peel_fresh', 'A_percent_moisture')).toFixed(2);
                    //*********************************ข้อมูลเปลือกดิน********************************************
...
%>
            ...
            <input type="hidden" name="chkNull" id="chkNull" value="A_doc_id,A_doc_date,A_wh_in,A_wh_out,A_cassava_date,A_amount_cassava_a,A_percent_tapioca_a,A_amount_tapioca_a,A_peel_fresh_date,A_percent_moisture,A_total_peel_fresh,A_amount_peel_fresh,A_soil_crust_date,A_amount_soil_crust,A_total_cassava,A_total_tapioca,A_reporter_id,A_purchase_id,A_production_id">
                        ...
                        <td  colspan="2" class="fcentercenter">
                            <div align="left">
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        <td class="columnlabel"><input type="button" class="cgcButton_8" id="runid" name="runid" value="เลขที่เอกสาร" onclick="AjaxRun_id('A_doc_id', '../JSP/BW_CS_023.jsp?status_runid=5')"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject"><table width="200" border="0">
                                                ...
                                                <tr>
                                                    <td><span class="columnlabel">วันที่ส่งหัวมันสด&nbsp;<input name='A_cassava_date' type='text' id="A_cassava_date" value='' size='10' readonly="readonly" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>%แป้งซื้อเข้า
                                                        ...
                                                        %</td>
                                                    <td>คิดเป็น
                                                        <input name="A_amount_tapioca_a" type="text" id="A_amount_tapioca_a" size="10" class="textboxtotal" readonly="readonly">กก.</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>%แป้งซื้อเข้า
                                                        ...
                                                        %</td>
                                                    <td>คิดเป็น
                                                        <input name="A_amount_tapioca_p" type="text" id="A_amount_tapioca_p" size="10" class="textboxtotal" readonly="readonly">กก.</td>
                                                </tr>
                                            </table></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="columnobject"><table width="200" border="0">
                                                ...
                                                <tr>
                                                    <td>ปริมาณวันที่
                                                        <input name="A_peel_fresh_date" type="text" id="A_peel_fresh_date" size="10">
                                                    </td>
                                                    <td>หักความชื้น%
                                                ...
                                                <tr>
                                                    <td><span class="columnlabel">จำนวน&nbsp;
                                                            <input name='A_amount_peel_fresh' type='text' id="A_amount_peel_fresh" value='' size='10' readonly="readonly" class="textboxtotal"/>
                                                            &nbsp;กก.</span></td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject"><table width="200" border="0">
                                                ...
                                                <tr>
                                                    <td>ปริมาณวันที่
                                                        <input name="A_soil_crust_date" type="text" id="A_soil_crust_date" size="10">
                                                    </td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">จำนวนมันสุทธิ
                                            <input type="text" name="A_total_cassava" id="A_total_cassava" class="textboxtotal" readonly="readonly">
                                            กก.&nbsp;&nbsp;&nbsp;&nbsp;%แป้ง
                                            <input type="text" name="A_total_tapioca" id="A_total_tapioca" class="textboxtotal" readonly="readonly">
                                            กก.</td>
                                    </tr>
                                    <tr>
                                        <td class="columnlabel">&nbsp;</td>
