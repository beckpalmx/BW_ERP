            ...
            <div align="center">
                <table  cellpadding="0"  cellspacing="0" >
                    <tr >
                        ...
                        <td  class="ftopcenter" colspan="2">รายงานการผลิตแป้งปรจำวันII(BW_CS_030)&nbsp;</td>
                        ...
                        <td  colspan="2" class="fcentercenter">
                            <div align="left">
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        <td class="columnlabel"><input type="button" class="cgcButton_9" id="bt1" onClick="sub_Screen('BW_CS_Detail_030_3');" value="  รายงานการโม่มัน  "/></td>
                                    ...
                                    <tr>
                                        <td class="columnlabel">ผู้ทวนสอบ                                 </td>
