        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp;
                    <b>สรุปการรับ - จ่าย สินค้า (แป้งมันสำปะหลัง) V1 (CS_Trans_Warehouse_Balance_Scr_V1)</b>
                </div>                

                <div class="panel-footer">

                    <form name ="report" action="CS_Trans_Warehouse_Balance_Prc_V1.jsp" target="_blank" method ="post">
