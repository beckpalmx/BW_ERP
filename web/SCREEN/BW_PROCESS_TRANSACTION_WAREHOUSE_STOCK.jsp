...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function summit_data() {
                ...
                getsaveApprove2(URLsend(IDsend, "../JSP/BW_PROCESS_TRANSACTION_SUPPLIER_STOCK.jsp"), "report");
            }
        </script>        
    ...
    <body onload="addDate();">
        ...
        <input type="hidden" id="process_for" name="process_for" value="WAREHOUSE_STOCK">            
        ...
        <div class="container">
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-tasks"></span>&nbsp;
                    <b>ประมวลผลคลังสินค้า (เบิก-จ่าย แป้งมันสำปะหลัง) (BW_PROCESS_TRANSACTION_WAREHOUSE_STOCK)</b>
                </div>                        
