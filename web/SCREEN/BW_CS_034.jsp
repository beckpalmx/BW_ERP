    ...
    <body>
        ...
        <table  cellpadding="0"  cellspacing="0">
            <tr>
                ...
                <td  class="ftopcenter" colspan="2">ใบปรับยอดสินค้า(CS_034)&nbsp;</td>
                                        ...
                                        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                            <tr>
                                                ...
                                                <td colspan="6" class="btn_multi">
                                                    <input type='button' name='but1' value='  เพิ่ม  ' onClick="javascript:getId('status_cancle').value?goAddChild(URLsend('doc_id,doc_date,status_a,username','CS_116.jsp')):alert('กรุณาบันทึกข้อมูลก่อนเพิ่มรายละเอียด');"/>
                                            ...
                                            <tr>
                                                ...
                                                <td class="row3" width="15%">จำนวน&nbsp;</td>
