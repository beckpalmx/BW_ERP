                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <td class="columnobject"><input name='A_prod_id' class='inputs' type="text" id="A_prod_id" value='<%=product_id%>' size='35' />
                                  <img width="20" height="20" border="0" align="middle" onclick="openBrWindow('vproduct&textinput=A_prod_id|A_prod_id_desc', 31, 'Search_Detail.jsp');" style="cursor: pointer;" name="IMAGE3" alt="ค้นหา" src="../IMAGES/BUTTON/MAIN/SEARCH20.png">
                                    <input class='inputs' type="text" name="A_prod_id_desc" id="A_prod_id_desc" value="" size="40">
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td class="columnobject"><input name='A_pack' class='inputs' type="text" id="A_pack" value='<%=pack%>' size='10' onblur="Cal_T('A_pack','A_qty','A_weight')" /></td>
                            </tr>
                            <tr>
                          ...
                          <td class="columnobject">
                              <input name='A_weight' class='inputs' type="text" id="A_weight" value='<%=weight%>' size='10' readonly/>                                </td>
                            </tr>
