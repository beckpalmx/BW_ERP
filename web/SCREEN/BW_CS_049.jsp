                                                ...
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                    <tr>
                                                        ...
                                                        <td colspan="4" class="btn_multi">
                                                            <input type='button' name='but1' value='  เพิ่ม  ' onClick="javascript:goAddChild(URLsend('doc_id,doc_date,wh_in,wh_out,net_weight,status_a,username','CS_043.jsp'));"/>
                                                            <input type='button' name='but2' value='  ลบ  ' onclick='javascript:goDelChild();'/>
                                                        </td>
                                                    </tr>
                                                    <tr>
