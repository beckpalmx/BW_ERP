            ...
            <%
                ...
                if (!request.getParameter("date_from").equals("") && !request.getParameter("date_to").equals("") && !request.getParameter("date_from").equals(null) && !request.getParameter("date_to").equals(null)) {
                    sql_where = " WHERE to_date(format_date(doc_date),'YYYY-MM-DD') between to_date(format_date2('"
                            ...
                            + request.getParameter("date_to") + "'),'YYYY-MM-DD') and pgroup_id = '" + pgroup_id + "' and ptype_id = '" + ptype_id + "'";
                }
                ...
                while (rec_raw_location != null && (rec_raw_location.next())) {
                    ...
                    SqlIns_Tmp_Rawmat = "INSERT INTO tmp_mrawmat_current_movement(location_id,period_month,create_date,create_by,period_year,remark) VALUES "
                ...
                String sql_tmp_rawmat = " Select * from tmp_mrawmat_current_movement Order By location_id ";
                STateMent = Conn.createStatement();
                STateMent = Conn.createStatement();
                STateMentData = Conn2.createStatement();
            ...
            <div class="jumbotron">
                <div class="container">
                    <table border ="1"  cellpadding="0"  cellspacing="0" class="myTable">
                        <center><h2>รายงานความเคลื่อนไหววัตถุดิบ (ถ่านสี - ถุงใหญ่)</h2></center>
